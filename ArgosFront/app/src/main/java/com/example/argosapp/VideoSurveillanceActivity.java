...
public class VideoSurveillanceActivity extends AppCompatActivity implements WebSocketNotificationListener {

    // TAG pour les logs
    private static final String TAG = "VideoSurveillance";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnCam1 = findViewById(R.id.btn_cam1);
        btnCam1.setBackgroundColor(Color.GRAY);
        ...
        // Lancement de l'activité Notifications lorsqu'on clique sur l'icône
            ...
            runOnUiThread(() -> {
                ...
                peerConnection.createOffer(new SimpleSdpObserver() {
                    ...
                    public void onCreateSuccess(SessionDescription desc) {
                        ...
                        offerMsg.setStreamId("mystream1");
