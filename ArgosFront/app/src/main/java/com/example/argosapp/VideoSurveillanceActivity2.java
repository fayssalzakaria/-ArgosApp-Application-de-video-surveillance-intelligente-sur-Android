...
public class VideoSurveillanceActivity2 extends AppCompatActivity implements WebSocketNotificationListener {

    // TAG pour les logs
    private static final String TAG = "VideoSurveillance2";
    ...
    private static final String CLIENT_ID = "androidClient2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Bouton caméra 2 désactivé (grisé)
        Button btnCam2 = findViewById(R.id.btn_cam2);
        btnCam2.setBackgroundColor(Color.GRAY);
            ...
            runOnUiThread(() -> {
                ...
                peerConnection.createOffer(new SimpleSdpObserver() {
                    ...
                    public void onCreateSuccess(SessionDescription desc) {
                        ...
                        offerMsg.setStreamId("mystream2");
