...
public class VideoSurveillanceActivity3 extends AppCompatActivity implements WebSocketNotificationListener {

    // TAG pour les logs
    private static final String TAG = "VideoSurveillance3";
    ...
    private static final String CLIENT_ID = "androidClient3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnCam3 = findViewById(R.id.btn_cam3);
        btnCam3.setBackgroundColor(Color.GRAY);
            ...
            runOnUiThread(() -> {
                ...
                peerConnection.createOffer(new SimpleSdpObserver() {
                    ...
                    public void onCreateSuccess(SessionDescription desc) {
                        ...
                        offerMsg.setStreamId("mystream3");
